...
class FavoritesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favorite" do
    assert_difference('Favorite.count') do
      post favorites_url, params: { favorite: { comment: @favorite.comment, rating: @favorite.rating, title: @favorite.title } }
    end
  ...
  test "should update favorite" do
    patch favorite_url(@favorite), params: { favorite: { comment: @favorite.comment, rating: @favorite.rating, title: @favorite.title } }
